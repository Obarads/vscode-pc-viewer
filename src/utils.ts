...
export function getEditorInfo() {
	...
	const gridSize = pcviewerResource.get('gridSize');
	const autoGridSize = pcviewerResource.get('autoGridSize');
	...
	return { pointMaxSize, backgroundColor, pointDefaultSize, displayGridHelper, gridSize, autoGridSize, pointDefaultColor, reverseCoordinate, rotateCoordinate, viewPoint, fileNumChannels };
}
