...
function GridHelperParams(grid_size, auto_grid_size, display) {
    ...
    */
    ...
    this.grid_size_auto = auto_grid_size;
...
class MainViewer {
    ...
    setupGridHelper(update_ghparams) {
        /**
    ...
    setupGUI() {
        ...
        gridHelperGUI.add(this.ghParams, "grid_size_x").min(0.1);
        gridHelperGUI.add(this.ghParams, "grid_size_y").min(0.1);
        gridHelperGUI.add(this.ghParams, "grid_size_z").min(0.1);
    ...
    updateGui() {
        ...
        if (this.ghParams.display) {
            ...
            if (this.ghParams.grid_size_x != this.ghParams.previous_grid_size_x
                || this.ghParams.grid_size_y != this.ghParams.previous_grid_size_y
